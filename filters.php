...
|--------------------------------------------------------------------------
|
| The following filters are used to verify role of the user of the current
| session logged into this application. Available roles
| * ADMIN - Admin
| * RDM_RESEARCHER - rdm researcher 
