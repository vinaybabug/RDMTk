...
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header">Expectancy Valance Learning Model Results</h3>
    </div>
    <!-- /.col-lg-12 -->
</div>
<div class="col-lg-12">
    ...
    <div class="panel-body">
             ...
             <table id="rsltTable" class="table table-striped table-bordered table-hover table-condensed">
                    <thead class="thead-inverse">
                        <tr>
                            ...
                            <th class="col-sm-1">G2EVL</th>   
                            <th class=" col-sm-1">Recenc</th>                            
                            <th class="col-sm-1">At tloss</th>
                            <th class="col-sm-1">Consist</th>  
                        </tr>
                    </thead>
        ...
        <div class="form-group">
            <a href="{{URL::to('dashboard/tools/monitoring/expr/anlys/list/evl/IGT')}}" class="btn btn-primary">Close</a>
        </div>
    </div>
    <!-- /.panel-body -->
...
//                alert(output.rslt.length);
                ...
                for(i=0; i< output.rslt.length; i++){
                    ...
                    cell4.innerHTML = output.rslt[i][3];
                    cell5.innerHTML = output.rslt[i][4];
                    cell6.innerHTML = output.rslt[i][5];                    
