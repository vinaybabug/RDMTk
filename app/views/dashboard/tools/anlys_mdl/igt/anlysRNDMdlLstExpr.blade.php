...
//            
            ...
            var req = ocpu.rpc("rdmtkIGTRandomModel", {
                taskType:"IGT",
                exprID:exprId,              
            }, function(output){          
         ...
         ocpu.seturl("https://172.16.88.128/ocpu/library/RDMTkAnalysisR/R");
            var req = ocpu.rpc("rdmtkIGTMdlRslts", {
                ...
                mdlType:"RND_MDL",
                  ...
                  JSONToCSVConvertor(output.rslt, "Random Model Report", true);
...
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header"><i class="fa fa-files-o fa-fw"></i> Random Model</h3>
    </div>
    <!-- /.col-lg-12 -->
</div>
<div class="col-lg-12">
                ...
                <table class="table table-striped table-bordered table-hover table-condensed">
                    ...
                    <tbody>
                        ...
                        <tr>
                           ...
                           <td class="text-center col-sm-1"><a href="{{ url('/dashboard/tools/monitoring/expr/anlys/exprs/rndMdlView/')}}/{{$exper->expertype}}/{{$exper->id}}/{{'RND_MDL'}}" id="{{$exper->id}}-view" class="btn btn-info disabled"><i class="fa fa-lg fa-eye" aria-hidden="true"></i></a></td>
                           ...
                           <td class="text-center col-sm-1">
                               {{ Form::open(array('action' => array('ExprAnlysController@submitAnlysJob', $exper->id, "IGT", "RND_MDL")))}}                                
